...
inserts = []
100.times do
  inserts.push "('user1@gmail.com', 'Car', '2016-11-17 17:00:00', '2016-11-17 17:00:00', 'skeddit', 2, '2016-01-02 01:00:00', '2016-06-05 01:00:00', 2, 'auto_book_true', 100, 2)"
end
sql = "INSERT INTO posts (email, vehicle, created_at, updated_at, description, price, start_time, end_time, creator_id, auto_book, max_radius, start_location_id) VALUES #{inserts.join(", ")}"
ActiveRecord::Base.connection.insert_sql(sql)

300.times do
  inserts.push "('user1@gmail.com', 'Bike', '2016-11-17 17:00:00', '2016-11-17 17:00:00', 'skeddit', 3, '2016-01-02 01:00:00', '2016-06-05 01:00:00', 2, 'auto_book_true', 100, 3)"
end
sql = "INSERT INTO posts (email, vehicle, created_at, updated_at, description, price, start_time, end_time, creator_id, auto_book, max_radius, start_location_id) VALUES #{inserts.join(", ")}"
ActiveRecord::Base.connection.insert_sql(sql)
=end
