...
inserts = []
500.times do
  inserts.push "('user1@gmail.com', 'Bike', '2016-11-17 17:00:00', '2016-11-17 17:00:00', 'skeddit', 5, '2016-01-02 01:00:00', '2016-06-05 01:00:00', 4, 'auto_book_true', 100, 1)"
end
sql = "INSERT INTO posts (email, vehicle, created_at, updated_at, description, price, start_time, end_time, creator_id, auto_book, max_radius, start_location_id) VALUES #{inserts.join(", ")}"
ActiveRecord::Base.connection.insert_sql(sql)
...
inserts = []
600.times do
  inserts.push "('user1@gmail.com', 'Boat', '2016-11-17 17:00:00', '2016-11-17 17:00:00', 'skeddit', 6, '2016-01-02 01:00:00', '2016-06-05 01:00:00', 5, 'auto_book_true', 100, 1)"
end
sql = "INSERT INTO posts (email, vehicle, created_at, updated_at, description, price, start_time, end_time, creator_id, auto_book, max_radius, start_location_id) VALUES #{inserts.join(", ")}"
ActiveRecord::Base.connection.insert_sql(sql)
...
inserts = []
700.times do
  inserts.push "('user1@gmail.com', 'Other', '2016-11-17 17:00:00', '2016-11-17 17:00:00', 'skeddit', 7, '2016-01-02 01:00:00', '2016-06-05 01:00:00', 6, 'auto_book_true', 100, 1)"
end
sql = "INSERT INTO posts (email, vehicle, created_at, updated_at, description, price, start_time, end_time, creator_id, auto_book, max_radius, start_location_id) VALUES #{inserts.join(", ")}"
ActiveRecord::Base.connection.insert_sql(sql)
